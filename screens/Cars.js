        ...
        >
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Hikouki.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Hune.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Kurumaisu.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Sinkansen.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Kyukyusya.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Torakku.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
          ...
          <Card style={[styles.card, styles.card1]}>
            <View style={[styles.cardBase, styles.cbbc0]}>
              ...
              <View style={styles.photoFlame}>
                <Image source={require("../assets/images/Cars/Kuruma.jpg")}/>
              </View>
              <View style={[styles.cardButtonBase]}>
